  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden perspective-container" style={{ background: "var(--gradient-hero)" }}>
        ...
        <div className="absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full bg-3d-element animate-3d-float"></div>
        <div className="absolute top-40 right-20 w-16 h-16 bg-secondary/20 rounded-full bg-3d-element animate-3d-float animation-delay-3d-200"></div>
        <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-accent/20 rounded-full bg-3d-element animate-3d-float animation-delay-3d-400"></div>
        <div className="absolute bottom-40 right-1/3 w-14 h-14 bg-primary/20 rounded-full bg-3d-element animate-3d-float animation-delay-3d-600"></div>
        <div className="absolute top-1/2 left-1/2 w-8 h-8 bg-white/15 rounded-full bg-3d-element animate-3d-float animation-delay-3d-800"></div>
        <div className="absolute top-1/3 right-1/4 w-10 h-10 bg-secondary/15 rounded-full bg-3d-element animate-3d-float animation-delay-3d-1000"></div>
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-6xl md:text-7xl font-bold text-white mb-8 bg-gradient-to-r from-white via-blue-100 to-green-100 bg-clip-text text-transparent text-3d animate-3d-slide-up leading-tight">
              ...
              <span className="text-transparent bg-gradient-to-r from-green-300 to-blue-300 bg-clip-text text-3d-glow">
                Secure, and Smart
              </span>
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-12 animate-3d-slide-up animation-delay-3d-200 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-3d-slide-up animation-delay-3d-400">
              <Link to="/signup">
                <Button size="lg" variant="secondary" className="w-full sm:w-auto btn-3d hover-3d-lift shadow-lg text-lg px-8 py-4">
                  <span className="animate-3d-float">🚀</span> Get Started Free
                </Button>
              </Link>
              <Link to="/auth">
                <Button size="lg" variant="outline" className="w-full sm:w-auto bg-white/10 text-white border-white/30 hover:bg-white/20 btn-3d hover-3d-lift text-lg px-8 py-4">
                  <span className="animate-3d-float animation-delay-3d-200">🔐</span> Sign In
                </Button>
              </Link>
            </div>
            
            {/* Trust Indicators */}
            <div className="mt-16 animate-3d-slide-up animation-delay-3d-600">
              <p className="text-white/70 mb-6 text-sm uppercase tracking-wider font-semibold animate-3d-slide-in-left">Trusted by thousands</p>
              <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                <div className="flex items-center gap-2 hover-3d-tilt animate-3d-slide-in-left animation-delay-3d-200">
                  <Shield className="w-5 h-5 text-green-400 animate-3d-float" />
                  <span className="text-white/80 font-medium">FDIC Insured</span>
                </div>
                <div className="flex items-center gap-2 hover-3d-tilt animate-3d-zoom-in animation-delay-3d-400">
                  <Lock className="w-5 h-5 text-blue-400 animate-3d-float animation-delay-3d-200" />
                  <span className="text-white/80 font-medium">Bank-Level Security</span>
                </div>
                <div className="flex items-center gap-2 hover-3d-tilt animate-3d-slide-in-right animation-delay-3d-600">
                  <Zap className="w-5 h-5 text-yellow-400 animate-3d-float animation-delay-3d-400" />
      ...
      <section className="py-24 bg-gradient-to-b from-background to-muted/20 relative overflow-hidden perspective-container">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-semibold mb-6 animate-3d-slide-up hover-3d-tilt">
              <Zap className="w-4 h-4 animate-3d-float" />
              Why Choose Finovia Bank?
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent text-3d animate-3d-slide-up animation-delay-3d-200">
              Finovia Banking That Works for You
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-3d-slide-up animation-delay-3d-400">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="card-3d hover-3d-lift group animate-3d-slide-in-left animation-delay-3d-600 border-2 hover:border-primary/20">
              <CardContent className="pt-8 pb-8">
                ...
                <div className="mt-4 flex items-center text-sm text-primary font-semibold group-hover:translate-x-2 transition-transform duration-300 hover-3d-tilt">
                  Learn more →
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="card-3d hover-3d-lift group animate-3d-zoom-in animation-delay-3d-800 border-2 hover:border-secondary/20">
              <CardContent className="pt-8 pb-8">
                ...
                <div className="mt-4 flex items-center text-sm text-secondary font-semibold group-hover:translate-x-2 transition-transform duration-300 hover-3d-tilt">
                  Learn more →
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="card-3d hover-3d-lift group animate-3d-slide-in-right animation-delay-3d-1000 border-2 hover:border-accent/20">
              <CardContent className="pt-8 pb-8">
                ...
                <div className="mt-4 flex items-center text-sm text-accent font-semibold group-hover:translate-x-2 transition-transform duration-300 hover-3d-tilt">
                  Learn more →
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-24 relative overflow-hidden perspective-container" style={{ background: "var(--gradient-success)" }}>
        ...
        <div className="absolute bottom-10 right-10 w-24 h-24 bg-white/10 rounded-full bg-3d-element animate-3d-float animation-delay-3d-200"></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-white/10 rounded-full bg-3d-element animate-3d-float animation-delay-3d-400"></div>
        <div className="absolute top-1/3 right-1/3 w-20 h-20 bg-white/10 rounded-full bg-3d-element animate-3d-float animation-delay-3d-600"></div>
        <div className="absolute bottom-1/3 left-1/2 w-12 h-12 bg-white/10 rounded-full bg-3d-element animate-3d-float animation-delay-3d-800"></div>
        
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/20 text-white px-6 py-3 rounded-full text-sm font-semibold mb-8 animate-3d-slide-up hover-3d-tilt">
              <Shield className="w-4 h-4 animate-3d-float" />
              Join 50,000+ Happy Customers
            </div>
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 text-3d animate-3d-slide-up animation-delay-3d-200 leading-tight">
              Ready to start your<br />
              <span className="text-transparent bg-gradient-to-r from-yellow-200 to-white bg-clip-text text-3d-glow">
                secure Finovia banking journey?
              </span>
            </h2>
            <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed animate-3d-slide-up animation-delay-3d-400">
            ...
            <div className="flex justify-center animate-3d-slide-up animation-delay-3d-600">
              <Link to="/signup">
                <Button size="lg" className="bg-white text-secondary hover:bg-white/90 btn-3d hover-3d-lift text-lg px-8 py-4 shadow-lg">
                  <span className="animate-3d-float">🎉</span> Open Your Account Today
                </Button>
              </Link>
            </div>
            
            {/* Social Proof */}
            <div className="mt-16 animate-3d-slide-up animation-delay-3d-800">
              <p className="text-white/70 mb-6 text-sm uppercase tracking-wider font-semibold animate-3d-slide-in-left">Trusted by leading companies</p>
              <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                <div className="flex items-center gap-2 hover-3d-tilt animate-3d-slide-in-left animation-delay-3d-200">
                  <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center hover-3d-rotate">
                    <Shield className="w-4 h-4 text-white animate-3d-float" />
                  </div>
                  <span className="text-white/80 font-medium">Enterprise Security</span>
                </div>
                <div className="flex items-center gap-2 hover-3d-tilt animate-3d-zoom-in animation-delay-3d-400">
                  <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center hover-3d-rotate">
                    <Zap className="w-4 h-4 text-white animate-3d-float animation-delay-3d-200" />
                  </div>
                  <span className="text-white/80 font-medium">Lightning Fast</span>
                </div>
                <div className="flex items-center gap-2 hover-3d-tilt animate-3d-slide-in-right animation-delay-3d-600">
                  <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center hover-3d-rotate">
                    <Globe className="w-4 h-4 text-white animate-3d-float animation-delay-3d-400" />
                  </div>
